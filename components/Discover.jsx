...
const Discover = () => {
    ...
    const discoverData = [
        {
            id: 1,
            title: 'Muk',
            imageUrl: '/images/discover1.jpg',
            desc: '24 hours available'
        },
        {
            id: 2,
            title: 'Muk',
            imageUrl: '/images/discover2.jpg',
            desc: '24 hours available'
        },
        {
            id: 3,
            title: 'Muk',
            imageUrl: '/images/discover3.jpg',
            desc: '24 hours available'
        },
        {
            id: 4,
            title: 'Muk',
            imageUrl: '/images/discover4.jpg',
            desc: '24 hours available'
        },
        {
            id: 5,
    ...
    return (
        <DiscoverSection id="discover">
            <DiscoverTitle>Discover <br /> section</DiscoverTitle>
            <DiscoverContainer>
                <Swiper
                    effect='coverflow'
                    grabCursor={true}
